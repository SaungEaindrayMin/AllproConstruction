...
import building1 from "../../../public/images/ProjectBuilding.jpg";
import building2 from "../../../public/images/ProjectBuilding2.jpg";
      ...
      >
        ...
        <div className={`space-y-6 ${reverse ? "lg:order-2" : ""}`}>
          ...
          <div className="flex items-center gap-x-3">
            ...
            <ArrowRight className="text-primary font-light" />
          </div>
        </div>
